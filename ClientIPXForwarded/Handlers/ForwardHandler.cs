...
namespace ClientIPXForwarded.Handlers
{
    public class ForwardHandler : DelegatingHandler
    {
    ...
    public static class HttpRequestMessageExtension
    {
        ...
        public static Uri GetSelfReferenceBaseUrl(this HttpRequestMessage request)
        {
            ...
            if (request.Properties.TryGetValue(
                ForwardHandler.MyClientBaseUrlProperty,
                out object baseUrl))
            {
                return (Uri)baseUrl;
            }
        ...
        public static Uri RebaseUrlForClient(this HttpRequestMessage request, Uri serverUrl)
        {
            ...
            {
                Scheme = clientBase.Scheme,
                Host = clientBase.Host,
                Port = clientBase.Port
            };
        ...
        public static string GetClientIpAddress(this HttpRequestMessage request)
        {
            if (request == null)
                return null;
            if (request.Properties.TryGetValue(ForwardHandler._fwdForHeader, out object ip))
            {
                return (string)ip;
            }
            return null;
